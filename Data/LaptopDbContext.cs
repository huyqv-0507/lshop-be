...
namespace Data
{
    public class LaptopDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=tcp:huyserver.database.windows.net,1433;Initial Catalog=huydb;Persist Security Info=True;User ID=huynl;Password=huyvuong0507##;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            }
        }
